      ...
      <div className="about-content">
        ...
        <div className="about-text">
          <div className="text-content glass">
            ...
            <p>
              Bunların dışında kendim hobi olarak Photoshop,Premiere Pro gibi editörleri amatör seviyede kullanıyorum.Genellikle macOS ortamında çalışıyorum.QtDesigner uyugulaması ile python tabanlı frontend geliştiriyorum.
              Ayrıca hobi olarak resim çizmeyi matematik ve geometri ile uğraşmaktan keyif alıyorum.Tabi tüm bunları yaparken bir taraftanda bilek güreşi sporuyla ilgileniyorum.
            </p>
          </div>
